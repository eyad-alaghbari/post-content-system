                ...
                <div class="border-t border-gray-200 px-4 py-5 pt-4 sm:px-6">
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex items-center space-x-4 mb-4">
                            ...
                            <img id="imagePreview" src="" alt="Preview of the image" width="200"
                                height="200" style="display: none;" />
                            <video id="videoPreview" src="" alt="Preview of the video" controls
                                style="display: none;"></video>
                            <audio id="audioPreview" src="" alt="Preview of the audio" controls
